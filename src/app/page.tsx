          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/employers/register" className="hover:text-blue-400">For Employers</Link></li>
                <li><Link href="/login" className="hover:text-blue-400">Student Login</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#" className="hover:text-blue-400">Career Guide</Link></li>
                <li><Link href="#" className="hover:text-blue-400">Resume Tips</Link></li>
                <li><Link href="#" className="hover:text-blue-400">Interview Prep</Link></li>
                <li><Link href="#" className="hover:text-blue-400">Skills Development</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>Email: contact@silvercrest.edu</li>
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-gray-400">
                For school administrators and staff only
              </p>
            </div>
          </div>
